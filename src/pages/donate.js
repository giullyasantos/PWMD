...
import twoeasy from'../images/donate/sponsors/2easy.png';
import akumin from'../images/donate/sponsors/akumin.PNG';
import alpha from'../images/donate/sponsors/alpha.png';
import brink from'../images/donate/sponsors/brink.png';
import cg from'../images/donate/sponsors/cgdentist.webp';
import citystone from'../images/donate/sponsors/citystone.webp';
import classcompany from'../images/donate/sponsors/celebration.png';
import contjewel from'../images/donate/sponsors/oz.webp';
import dominium from'../images/donate/sponsors/dominium.png';
import donmatt from'../images/donate/sponsors/donmatthews.webp';
import fcu from'../images/donate/sponsors/fcu.PNG';
import godshouse from'../images/donate/sponsors/godshouse.webp';
import hispanicfed from'../images/donate/sponsors/hispanicfed.webp';
import kendrascott from'../images/donate/sponsors/kendra.webp';
import nlinsurance from'../images/donate/sponsors/nlinsurance.PNG';
import perfumeland from'../images/donate/sponsors/perfumeland.png';
import rainbow from'../images/donate/sponsors/rainbow.webp';
import redeemer from'../images/donate/sponsors/redeemer.webp';
import resurrect from'../images/donate/sponsors/resurrect.webp';
import susancruzalegui from'../images/donate/sponsors/susancruzalegui.webp';
import uhcn from'../images/donate/sponsors/uhcn.webp';
import ups from'../images/donate/sponsors/ups.png';
import ultrasound from'../images/donate/sponsors/ultrasound.webp';
import usfoot from'../images/donate/sponsors/usfootcare.PNG';
import vitrine from'../images/donate/sponsors/vitrinecharmosa.webp';
        ...
        <section className='sponsors'>
            ...
            <div className='photo-slider'>
                <div className='slide-track'>
                    <div className='slide'>
                        <img src={twoeasy} alt="2easy Insurance"/>
                    </div>
                    <div className='slide'>
                        <img src={akumin} alt="Akumin"/>
                    </div>
                    <div className='slide'>
                        <img src={alpha} alt="Alpha"/>
                    </div>
                    <div className='slide'>
                        <img src={brink} alt="Brink"/>
                    </div>
                    <div className='slide'>
                        <img src={cg} alt="Cg Dentist"/>
                    </div>
                    <div className='slide'>
                        <img src={citystone} alt="CityStone"/>
                    </div>
                    <div className='slide'>
                        <img src={classcompany} alt="Celebration Education Institute"/>
                    </div>
                    <div className='slide'>
                        <img src={contjewel} alt="OZ Jewelry"/>
                    </div>
                    <div className='slide'>
                        <img src={dominium} alt="Dominium Accounting"/>
                    </div>
                    <div className='slide'>
                        <img src={donmatt} alt="Don Matthews Law"/>
                    </div>
                    <div className='slide'>
                        <img src={fcu} alt="Florida Christian University"/>
                    </div>
                    <div className='slide'>
                        <img src={godshouse} alt="God's House"/>
                    </div>
                    <div className='slide'>
                        <img src={hispanicfed} alt="Hispanic Federation"/>
                    </div>
                    <div className='slide'>
                        <img src={kendrascott} alt="Kendra Scott"/>
                    </div>
                    <div className='slide'>
                        <img src={nlinsurance} alt="NL Insurance"/>
                    </div>
                    <div className='slide'>
                        <img src={perfumeland} alt="Perfumeland"/>
                    </div>
                    <div className='slide'>
                        <img src={rainbow} alt="Rainbow Real Painting"/>
                    </div>
                    <div className='slide'>
                        <img src={redeemer} alt="Redeemer Printing"/>
                    </div>   
                    <div className='slide'>
                        <img src={resurrect} alt="Ressurect Wood"/>
                    </div>   
                    <div className='slide'>
                        <img src={susancruzalegui} alt="Susan Cruzalegui Life Coach"/>
                    </div>   
                    <div className='slide'>
                        <img src={uhcn} alt="UHCN"/>
                    </div> 
                    <div className='slide'>
                    ...
                    <div className='slide'>
                        <img src={usfoot} alt="US Footcare"/>
                    </div>  
                    <div className='slide'>
                        <img src={vitrine} alt="Vitrine Charmosa"/>
                    </div>    
                </div>
            </div>
            <a className='underline-animation' href="https://www.paypal.com/paypalme/pwmdfoundation"><h4>Become A Sponsor</h4></a>
        </section>
