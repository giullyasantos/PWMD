...
const Footer = () => {
  ...
  return (
    <div className='footer'>
            <div className='side1'>
                <img className='logo' src={PWMDnoback} alt="PWMD Logo"/>
		...
		<a href='https://www.google.com/maps/dir//people+who+make+a+difference/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x88e77e78e4fa3c8d:0x5e24cac5ad0dbe0e?sa=X&ved=1t:3061&ictx=111' id='address'>7061 Grand National Dr. Suite: 105 B - Orlando, FL 32819</a>
                ...
                <div className='verse'><p><strong>The Lord is my Shepherd, I shall not want! - Psalms 23:1</strong></p></div>
            </div> 
            <div className="selections">
                <div className="first">
                    <div id='get-involved'>
                        ...
                        <a className='links' href='/volunteer'>Volunteer</a>
                    </div>
                    <div id='abt-us'>
                        <h4 className='footer-title'>About Us</h4>
                        <a className='links' href='/about'>Our Mission</a>
                    </div>
                    <div id='get-help'>
                        <h4 className='footer-title'>Get Help</h4>
                        <a className='links' href='https://docs.google.com/forms/d/e/1FAIpQLSf-yz7E3rh0U-9YMRPnNe2BVYGsniFucwvj-bJhQrJ5eWqAMQ/viewform'>Pink Prevention Program</a>
                        <a className='links' href='https://form.jotform.com/220835736434155'>Application for Assistance</a>
                        <a className='links' href='https://form.jotform.com/241494155228155'>Wheelchair Lending</a>
